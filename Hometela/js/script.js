...
function performSearch() {
  ...
  cards.forEach((card) => {
      ...
      const subTitle = card.querySelector('.card-sub-title').innerText.toLowerCase();
      const foundInTitle = searchMatch(title, searchText);
      const foundInSubtitle = searchMatch(subTitle, searchText);

      if (foundInTitle || foundInSubtitle) {
